...
{% block base_layer %}new OpenLayers.Layer.OSM( "Simple OSM Map");{% endblock %}
...
django.jQuery(document).ready(function() {
	...
	var lng, lat
	var $MaterialColor = django.jQuery('#id_MaterialColor');
	
	$MaterialColor.change(function() {
		geocod($MaterialColor.val(), mappa);
	});
